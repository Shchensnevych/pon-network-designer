...
- **MDU (Багатоквартирний будинок):**
  ...
  - **Схема під'їзду (FTTH):** Деталізована матриця (Горище -> Поверхи), що дозволяє розподіляти волокна між будинковими та поверховими дільниками аж до конкретних квартир.
