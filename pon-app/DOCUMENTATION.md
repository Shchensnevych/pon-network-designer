...
- **Ергономічна панель інструментів (Figma-style):** Перероблені кнопки інструментів згруповано у стильну, компактну та симетричну 2-рядну сітку. Кожен компонент має унікальний кольоровий акцент та об'ємну іконку (наприклад, 🗄️ OLT), що не перевантажує інтерфейс і максимально вивільняє площу карти для проектування.
